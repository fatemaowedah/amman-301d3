...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT because the rando variable is local for block scope we can't declare it outside this scope function it will give us not define 
  console.log(viewed);
